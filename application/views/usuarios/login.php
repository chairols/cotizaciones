...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="/assets/AdminBSBMaterialDesign-master/favicon.ico" type="image/x-icon">
...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);"><b>ROLLER SERVICE S.A.</b></a>
    ...
    <script src="/assets/AdminBSBMaterialDesign-master/plugins/jquery-validation/jquery.validate.js"></script>

    <!-- Custom Js -->
    <script src="/assets/AdminBSBMaterialDesign-master/js/admin.js"></script>
    <script src="/assets/AdminBSBMaterialDesign-master/js/pages/examples/sign-in.js"></script>
</body>
